...
# This file is an edited version of https://github.com/raspberrypi/rpi-sb-provisioner/tree/v1.3.6
...
if [ -n "${RPI_DISABLE_OTP_WRITE}" ]; then
    keywriter_log "Public key OTP fuse step skipped by config"
else
    keywriter_log "Warning: Fusing public key into OTP"
